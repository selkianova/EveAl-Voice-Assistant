...
def chatGPT(prompt):
    try:
        # Adapted to a newer model following the deprecation of text-davinci-003.
        response = client.chat.completions.create(
            model="gpt-3.5-turbo", 
            messages=[
                {"role": "system", "content": "You are Eve, a helpful, concise virtual assistant."},
        ...
        print(f"API Error: {e}")
        return "I am having trouble thinking right now. Could you please try again?"
